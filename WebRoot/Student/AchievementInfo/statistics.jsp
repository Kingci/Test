...
<%
	...
	String stu_id =  achiv_info_dao.query_stu_id(account);
...
<br/><br /><br /><br/>
<div class="sidebar">
  <div class="title">学分统计</div>
  <!-- ul -->
	<!-- <li><a href=""><span>学分统计</span></a></li> -->
  <!-- /ul -->
</div>
<div class="content">
<table width="98%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#595AAF" bordercolorlight="#FFFFFF">
  <tr align="center" bgcolor="#CCCCCC">
	...
	%> 
  <tr>
    <td style="padding:5px;">&nbsp;<%=course_type%></td>
...
%>
  <tr>
    <td style="padding:5px;">&nbsp;<%=total_s%></td>
