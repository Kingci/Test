...
<form id="form1" method="post" action="student?action=evaluateCourse">
	  	...
	  	if (account == null || "".equals(account)){
			...
			ChooseCourseTimeForm chooseCourseTimeForm = studentDAO.queryEvalCourseTime(account.substring(2,5));
			int id = -1;
			String nameC = "";
			String nameE = "";
			String semester = "";
			...
			if (courInfo != null && !courInfo.isEmpty() && chooseCourseTimeForm != null && chooseCourseTimeForm.getState()){
				out.println("<table width='716' height='213' border='1' cellpadding='0' cellspacing='1' align='center'>");
				out.println("<tr><td colspan='9' align='center'>课程评估</td></tr>");
				out.println("<tr><td>课程号</td><td>课程中文名</td><td>课程英文名</td><td>学期</td><td>学年</td></tr>");
				...
				while(it.hasNext()){
		  		...
		  		out.println("<tr><td><input type='submit' name='1' id='12' value='提交' /></td></tr>	</table>");
			}
