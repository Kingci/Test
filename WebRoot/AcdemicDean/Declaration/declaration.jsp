...
<table width="716" height="213" border="1" cellpadding="0" cellspacing="1" align="center">
  <%
	...
	if (ProjInfo != null && !ProjInfo.isEmpty()){
		out.println("<tr><td colspan='9' align='center'>现有项目</td></tr>");
		
	    out.println("<tr><td>项目名称</td><td>指导教师</td><td>项目简介</td><td>是否开启</td><td>删除项目</td><td>");
  ...
  %>
  <tr>
  <td><input type="submit" name="save" id="save" value="提交" /></td>
  </tr>
</table>
