...
<%
	...
	if (courInfo != null && !courInfo.isEmpty()){
		out.println("<table width='500' border='1' cellpadding='0' cellspacing='1' align='center'>");
		out.println("<tr height='30'><td colspan='3' align='center'>已发布通知</td></tr>");		
		out.println("<tr height='30'><td>通知编号</td><td width='300'>通知标题</td><td>删除与否</td></tr>");
		...
		while(it.hasNext()){
			...
			out.println("<td><input type='checkbox' name='"+notificationId+"' id='"+notificationId+"'/></td></tr>");
  		}
