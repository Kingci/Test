...
<form id="form1" method="post" action="acdemicDean?action=insertNotification">
  ...
  <tr>
    <td height='40' colspan="2" align="center">通知发布</td>
  </tr>
  <tr>
    <td width="40">标题</td>
  ...
  <tr>
    <td width="40">内容</td>
    <td width="680px" height="300px"><label for="content"></label>
      <textarea name="content" id="content" cols="45" rows="10" style="height:300px;width:680px"></textarea>
      </td>
  </tr>
  <tr>
